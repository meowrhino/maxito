import { resolveAsset } from '../core/data.js';

export const ARBRE_STAMP_TARGET_SLUG = 'arbre';
...
export const ARBRE_PRELOAD_SOURCES = ARBRE_STAMP_SOURCES.slice(0, 6);
...
export function syncArbreStamping(slug) {
